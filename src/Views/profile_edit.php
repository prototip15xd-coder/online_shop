            ...
            <form method="POST" action="">
                <table>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                                <input type="text" name="name" class="edit-input" value="<?php echo $user->getUserName(); ?>">
                        </td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td>:</td>
                        <td>
                                <input type="email" name="email" class="edit-input" value="<?php echo $user->getUserEmail(); ?>">
                        </td>
                    </tr>
                    <tr>
                        <td>password</td>
